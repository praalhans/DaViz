...
public abstract class Event extends Locus implements Cloneable {
	...
	static void matchAndLinkEvents(List<Event> events) {
		...
		HashMap<Node,Event> map = new HashMap<Node,Event>();
	...
	public boolean hasMatchingEvent() { return false; }
	public Event getMatchingEvent() { throw new Error("Only defined for Send or Receive"); }
	...
	public boolean hasHappensAt() { return true; }
	public Viewpoint.Node getHappensAt() {
		return happensAt;
	}
	
	public boolean hasNextState() { return false; }
	public Information.State getNextState() { throw new Error(); }
	
	public boolean hasMessage() { return false; }
	public Information.Message getMessage() { throw new Error(); }
	
	public boolean hasResult() { return false; }
	public Information.Result getResult() { throw new Error(); }
	
	public boolean hasSender() { return false; }
	public Viewpoint.Node getSender() { throw new Error(); }
	
	public boolean hasReceiver() { return false; }
	public Viewpoint.Node getReceiver() { throw new Error(); }
	...
	public static class ReceiveEvent extends Event {
		...
		public Information.Message getMessage() { return message; }
		
		public boolean hasNextState() { return true; }
		public Information.State getNextState() { return nextState; }
		
		public boolean hasSender() { return true; }
		public Viewpoint.Node getSender() { return sender; }
		
		public boolean hasMatchingEvent() { return true; }
	...
	public static class SendEvent extends Event {
		...
		public Viewpoint.Node getReceiver() { return receiver; }
		
		public boolean hasMatchingEvent() { return matchingEvent != null; }
		public ReceiveEvent getMatchingEvent() { return (ReceiveEvent) matchingEvent; }
